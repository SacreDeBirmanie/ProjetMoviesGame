...
public class update {
	...
	public void step1(HttpServletResponse resp){
		...
		try{
			...
			try{
				resp.getWriter().println("Problème step 1");
			} catch (Exception ex){}
		}
	}
	...
	public void step2(HttpServletResponse resp){
		...
		//////////////////////////////////////////////////////////////////////////////////////////
		////////////////////Verification que Les date_update initiales sont bien enregistrées/////
		//////////////////////////////////////////////////////////////////////////////////////////
	...
	//penser a actualiser la page autant de fois que nécessaire !
	public void step3(HttpServletResponse resp, boolean add_movies){
		//////////////////////////////////////////////////////////////////////////////////////////
		/////////////////////////Verification de la création de update_data///////////////////////
		////////////////////////////////////////et //////////////////////////////////////////////
		/////////////////////////test de l'ajout de donnees et vérification de date_update////////
		//////////////////////////////////////////////////////////////////////////////////////////
		...
		try{
			...
			if(nb_add_data>0){
				resp.getWriter().println("Voici le nombre de données ajoutées : "+(nb_add_data));
				resp.getWriter().println("Datastore Update");
			}else{
				resp.getWriter().println("Vos données sont à jour ! (c'est à dire qu'il n'y pas pas de film plus récent que dans le datastore !)");
			}
			if(add_movies){
			...
			try{
				resp.getWriter().println("Problème step 3 !");
			} catch (Exception ex){}
		}
	}
}
